...
app.layout = html.Div([
    ...
    dcc.RadioItems(
        options={'New York City': 'New York City', 'Montreal': 'Montreal', 'San Francisco': 'San Francisco'},
        value='Montreal',
        id='city-dd'
    ),
...
@callback(
    Output('city-output-container', 'children'),
    Input('city-dd', 'value'))
...
def update_output(n_clicks):
    ...
    euro_cities = {'Paris': 'Paris', 'London': 'London', 'Berlin': 'Berlin'}
    patched_dropdown.update(euro_cities)
