...
# update scatter plot on the left
@callback(
...
# update x time series chart on the right
@callback(
...
def update_x_timeseries(hoverData, xaxis_column_name, axis_type):
    ...
    title = '<b>{}<br>{}'.format(country_name, xaxis_column_name)
    return create_time_series(dff, axis_type, title)

# update y time series chart on the right
@callback(
